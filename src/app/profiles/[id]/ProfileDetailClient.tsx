              ...
              {profile.contactPhone && (
                <div className="mt-4 flex gap-3">
                  ...
                  <a
                    ...
                    className="inline-flex items-center gap-2 px-5 py-2.5 bg-maktub-green text-white rounded-xl text-sm font-medium shadow-sm hover:bg-maktub-green-dark transition-colors"
                  >

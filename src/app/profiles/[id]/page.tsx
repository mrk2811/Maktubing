            ...
            <Section title="Contact Information">
              <div className="bg-maktub-bubble-out/20 rounded-xl p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <a
                  ...
                  className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-maktub-green text-white font-medium text-sm hover:bg-maktub-green-dark transition-colors"
                >

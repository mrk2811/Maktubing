...
function profileToFormData(profile: Profile): FormData {
  return {
    ...
    lookingForAge: profile.lookingFor.ageRange === "Any" ? "" : profile.lookingFor.ageRange,
    lookingForHeight: profile.lookingFor.height === "Any" ? "" : profile.lookingFor.height,
    lookingForEthnicity: profile.lookingFor.ethnicity === "Any" ? "" : profile.lookingFor.ethnicity,
    lookingForResidence: profile.lookingFor.residence === "Any" ? "" : profile.lookingFor.residence,
    lookingForLegalStatus: profile.lookingFor.legalStatus === "Any" ? "" : profile.lookingFor.legalStatus,
    lookingForMaritalStatus: profile.lookingFor.maritalStatus === "Any" ? "" : profile.lookingFor.maritalStatus,
    lookingForReligiousSect: profile.lookingFor.religiousSect === "Any" ? "" : profile.lookingFor.religiousSect,
...
export default function EditProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const updatedProfile: Profile = {
      ...
      lookingFor: {
        ageRange: data.lookingForAge.trim() || "Any",
        height: data.lookingForHeight.trim() || "Any",
        ethnicity: data.lookingForEthnicity.trim() || "Any",
        residence: data.lookingForResidence.trim() || "Any",
        legalStatus: data.lookingForLegalStatus.trim() || "Any",
        maritalStatus: data.lookingForMaritalStatus.trim() || "Any",
        religiousSect: data.lookingForReligiousSect.trim() || "Any",
      },

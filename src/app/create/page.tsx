...
export default function CreateProfilePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const profile: Profile = {
      ...
      lookingFor: {
        ageRange: formData.lookingForAge.trim() || "Any",
        height: formData.lookingForHeight.trim() || "Any",
        ethnicity: formData.lookingForEthnicity.trim() || "Any",
        residence: formData.lookingForResidence.trim() || "Any",
        legalStatus: formData.lookingForLegalStatus.trim() || "Any",
        maritalStatus: formData.lookingForMaritalStatus.trim() || "Any",
        religiousSect: formData.lookingForReligiousSect.trim() || "Any",
      },
